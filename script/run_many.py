...
default_finetuning_config = {
    ...
    # ILPC (2)
    # "ILPC2022": (3, 'null'),  # ILPC small TODO: need fix
    # "ILPC2022": (1, 1000), # ILPC large TODO: need fix
    "ILPC2022SmallInductive": (1, 1000),
    ...
    for graph in datasets:
        ...
        for i in range(args.repeats):
            ...
            if "fast_test" in cfg.train:
                ...
                graph = copy.deepcopy(valid_data)
            ...
            train_and_validate(cfg, model, train_data, valid_data if "fast_test" not in cfg.train else short_valid, filtered_data=val_filtered_data, batch_per_epoch=batch_per_epoch, device=device, logger=logger)
            if util.get_rank() == 0:
